...
<head>
    ...
    <title>{{ $product->sales->customer->name }} || {{ setting('app_name') }} || Ticket Invoice</title>
...
<body>
    <div class="invoice-container">
        ...
        <div class="header" style="text-align:center;">
            <img src="{{ public_path(setting('primary_logo')) }}" alt="{{ setting('app_name') }}" style="width:200px" height=""
                style="margin-bottom:20px">
        </div>
<div class="section" style="padding: 20px 0px 0px 0px; display:flex; justify-content:space-between;">
    <address>
        <strong>Name:</strong> {{ $product->sales->customer->name??null }}<br>
        <strong>Mobile:</strong> {{ $product->sales->customer->phone??null }}<br>
    ...
    <div style="width:95%;">
                ...
                <div>
                    <table class="table">
                        <tbody>
                            <tr>
                                <td>Ticket Status</td>
                                <td style="font-weight: bold">{{ ucfirst(strtolower(str_replace('_',' ',$product->ticket_type))) }}</td>

                                <td>Total Price</td>
                                <td style="font-weight: bold">{{ number_format($product->sales->sale_price) }}/=</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
        ...
        height: auto; text-align: center;" alt="">
                     <p>
