            ...
            <div class="card">
                <div class="card-header">
                    <div class="card-title d-flex justify-content-between">
                        <div><button class="btn btn-sm btn-info click_pnr"><i class="fa fa-plus"></i>SHOW TICKET DETAILS
                                ({{ $ticket->ticket_pnr }})
                            </button></div>
                        <div>
                            ...
                            <table class="table table-bordered" style="width:100%">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td width="">
                                            Price: {{ number_format($ticket->purchase->purchase_price ?? null) }}/= <br>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td width="">Note</td>
                                        <td width="">{{ $ticket->purchase_note }}</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                            ...
                            <table class="table table-bordered" style="width:100%">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td width="">
                                            Price: {{ number_format($ticket->sales->sale_price) }}/=
                                        </td>
                                    </tr>
                                    <tr>
                                        <td width="">Sale profit</td>
                                        <td width="">{{ number_format($ticket->sales->sale_profit) }}/=</td>
                                    </tr>
                                    <tr>
                                        <td width="">Sale loss</td>
                                        <td width="">{{ number_format($ticket->sales->sale_loss) }}/=</td>
                                    </tr>
                                    <tr>
                ...
                <div class="card-body">
                    <form class="formSubmit" method="POST"
                        action="{{ route('admin.inventory.refundticket.refundStore') }}">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                <div class="input-group">
                                    <select name="refund_vendor_id" id="refund_vendor_id" readonly=""
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                <div class="input-group">
                                    ...
                                    <input name="customer_refund" id="customer_refund" type="number"
                                        class="form-control " placeholder="Enter Customer Refund" />
                                </div>
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                <div class="input-group">
                                    ...
                                    <input name="refund_date" id="refund_date" type="date" class="form-control "
                                        value="{{ old('refund_date', date('Y-m-d')) }}" placeholder="dd/mm/yyyy" />
                                </div>
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                <div class="input-group">
                                    ...
                                    <input name="refund_expected_date" id="refund_expected_date" type="date"
                                        class="form-control " value="{{ old('refund_expected_date', date('Y-m-d')) }}"
                                    ...
                                    <div class="input-group">
                                        <select name="profit_account_id" id="profit_account_id"
                                            ...
                                            @foreach (App\Models\AgencyAccount::all() as $item)
                                                <option value="{{ $item->id }}">
                                                    {{ $item->account_name }}-{{ $item->account_number }}-{{ $item->current_balance }}/=
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                        ...
                        <div class="text-center">
                            <button class="btn btn-secondary btn-sm" type="submit"> <i class="fas fa-sync"></i> Apply
                                Refund</button>
                        </div>
                    </form>
                </div>
